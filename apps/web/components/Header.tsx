    ...
    <header className="sticky top-0 z-50 w-full glass border-b border-white/10 backdrop-blur-xl">
      <div className="mx-auto max-w-screen-2xl px-6 flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-1 ml-8">
          <Link href="/" className="px-4 py-2 text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-all">
            Markets
          </Link>
          <Link href="/portfolio" className="px-4 py-2 text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-all">
            Portfolio
          </Link>
          <Link href="/become-creator" className="px-4 py-2 text-gray-400 hover:text-white hover:bg-white/5 rounded-lg transition-all">
            Become Creator
          </Link>
        </nav>
