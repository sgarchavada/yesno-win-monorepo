...
export const MARKET_FACTORY_ADDRESS = import.meta.env.VITE_MARKET_FACTORY_PROXY!;
export const CREATOR_REGISTRY_ADDRESS = import.meta.env.VITE_CREATOR_REGISTRY_PROXY!;
export const PROTOCOL_TREASURY_ADDRESS = import.meta.env.VITE_PROTOCOL_TREASURY_PROXY!;
export const ORACLE_ADAPTER_ADDRESS = import.meta.env.VITE_ORACLE_ADAPTER_ADDRESS || "";
